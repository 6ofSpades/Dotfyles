# Generated by Powerlevel10k configuration wizard on 2025-09-22 at 03:34 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=92
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=56
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%36F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=36
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=36
  ...
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=magenta
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=REPLACE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND=red
